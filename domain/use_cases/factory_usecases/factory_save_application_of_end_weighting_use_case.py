...
from data.factory_repository.factory_application_repository import FactoryPostgresApplicationRepository
...
class FactorySaveApplicationOfEndWeightingUseCase:
    ...
    def provide(self):
        app_rep: ApplicationRepository = FactoryPostgresApplicationRepository(
